...
export function ThermalPreview({ template, restaurantName, restaurant }: { template: TicketTemplate; restaurantName?: string; restaurant?: RestaurantOverride | null }) {
  const ctx = mockContext(template.kind, restaurantName, restaurant);
