...
import { Wine, Clock, Play, CheckCircle, Loader2 } from 'lucide-react';
...
export default function Bar() {
  ...
  const { tickets, isLoading, updateTicketStatus } = useKitchenTickets(restaurantId, 'bar');
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">KDS - Bar Display System</p>
          </div>
        ...
        {tickets.length === 0 ? (
          <Card className="glass-card p-12 text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">Sin pedidos de barra</h3>
